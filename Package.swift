...
let package = Package(
  ...
  products: [
    .library(
      name: "openssl_grpc_nearby",
      targets: ["openssl_grpc_nearby"]
    )
  ],
  ...
  targets: [
    .target(
      ...
      exclude: [
        ...
        "src/crypto/perlasm/ppc-xlate.pl",
        ...
        "src/crypto/fipsmodule/rand/asm",
        "src/crypto/fipsmodule/policydocs",
        "src/crypto/fipsmodule/modes/gcm_tests.txt",
        "src/crypto/fipsmodule/modes/asm",
        "src/crypto/fipsmodule/md5/asm",
        ...
        "src/crypto/fipsmodule/ec/make_p256-x86_64-tests.go",
        "src/crypto/fipsmodule/ec/make_p256-x86_64-table.go",
        "src/crypto/fipsmodule/ec/make_ec_scalar_base_mult_tests.go",
        "src/crypto/fipsmodule/ec/ec_scalar_base_mult_tests.txt",
        "src/crypto/fipsmodule/ec/asm",
        ...
        "src/crypto/cipher_extra/test",
        "src/crypto/cipher_extra/asm",
        "src/crypto/chacha/asm",
        "src/crypto/blake2/blake2b256_tests.txt",
        "src/crypto/asn1/charmap.pl",
